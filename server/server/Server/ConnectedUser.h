#pragma once
//ConnectedUser CPacketSession 상속
...
private:
	...
	BOOL mIsConnected; // 현재 접속 중인지를 확인하는 FLAG ( 접속개체 재활용 )

	TCHAR mNickName[32]; // 닉네임
	INT64 mGameMoney; // 게임머니
	INT64 mExp; //경험치

	CCharacter mCharacters[3]; // 캐릭터 배열 ( 최대 3개 )
	USHORT mSelectedCharacterSlot; //현재 선택한 슬롯
...
public:
	...
	//////////////////////////////////////////////////////////////////////////
	// 게임관련 함수들
	inline BOOL			InitializeForGameStart(VOID){ CThreadSync Sync; mHP = DEFAULT_MAX_HP; mAP = 0;  return TRUE; }
