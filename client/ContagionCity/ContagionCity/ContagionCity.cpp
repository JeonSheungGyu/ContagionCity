...
CAppManager* CAppManager::Instance = NULL;
                     ...
                     _In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_CONTAGIONCITY, szWindowClass, MAX_LOADSTRING);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_CONTAGIONCITY));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_CONTAGIONCITY);
